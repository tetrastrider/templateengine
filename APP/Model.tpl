...
class Modelo
{
    ...
    public function orden($campo=null,$orden='ASC'){

        if($campo===null){$this->sql.=" ORDER BY RAND()";return $this;}elseif($orden===null){$this->sql.=" ORDER BY $orden";return $this;}else{ $this->sql.=" ORDER BY $campo $orden";return $this;} }
