...
<nav>
  ...
  <a href="/realty"><div class="col" >Realty</div></a>
...
<!---->
<!--potadas-->
<div class="label"><h4>Portadas <i class="fa fa-picture-o"></i></h4><a class="hidden"><i class="fa fa-chevron-down"></i></a><a href="" class="serrar"><i class="fa fa-times"></i></a></div>
